/***********************************************************************
 * This header file contains the ADCmcp3008Spi class definition.
...
#ifndef ADCMCP3008SPI_H
#define ADCMCP3008SPI_H
#include <unistd.h>
#include <stdint.h>
#include <fcntl.h>
#include <sys/ioctl.h>
...
public:
    ADCmcp3008Spi();
    ADCmcp3008Spi(std::string devspi, unsigned char spiMode, unsigned int spiSpeed, unsigned char spibitsPerWord);
    ~ADCmcp3008Spi();
