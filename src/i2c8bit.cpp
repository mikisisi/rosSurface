...
//cout << "le retour vaut      "  << retVal << endl ;
...
int i2c8Bit::readReg(unsigned char reg_addr, unsigned char &data)
{
    ...
    //printf("\nlecture du registre %d   de valeur %d ",reg_addr,data);
//cout << endl << "lecture du registre :  " << reg_addr << "  de la carte avec addresse " <<  this->deviceAddress << "  sur le bus:  " <<  this->i2cFileName << endl ;
//cout << endl << "la valeur lue vaut :   "  ;
